# Getting help with apodR

Thanks for using apodR. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/apodR/issues) to make sure the 
