...
#' - `date` A string in YYYY-MM-DD format indicating the date of the APOD image (example: 2014-11-03).  Defaults to today's date.  Must be after 1995-06-16, the first day an APOD picture was posted.
...
#' - explanation: The supplied text explanation of the image, may have some HTML text still in it
